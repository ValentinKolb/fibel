...
Die Tools verwenden die vorhandene Fibel-Suche und den Seiteninhalt. Markdown-Dateien und das explizite `content`-Markdown von [Custom Pages](/de/docs/custom-pages) stehen damit zur Verfügung, ohne gerendertes HTML zu indexieren.
